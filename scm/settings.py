...
from scm.env import email_user_name,email_user_password
...
SECRET_KEY = 'django-insecure-ms&r%5tt96wf#=56$um%u7*4f3v=-fnjdu_4k-&ay9q2-jy%o='
...
if os.environ.get('DB_ENGINE') and os.environ.get('DB_ENGINE') == "mysql":
    DATABASES = {
        'default': {
            ...
            'USER': os.getenv('DB_USERNAME','vishal'), #vishal
            'PASSWORD': os.getenv('DB_PASS', '1234'), #1234
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = email_user_name
